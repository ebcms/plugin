...
<script>
    ...
    $(function() {
        ...
        EBCMS.check = function() {
            ...
            $.ajax({
                type: "GET",
                url: "{echo $router->build('/ebcms/plugin/check')}",
                data: {
                    name: "{$plugin.name}",
                },
                dataType: "json",
        ...
        EBCMS.source = function() {
            ...
            $.ajax({
                type: "GET",
                url: "{echo $router->build('/ebcms/plugin/source')}",
                data: {
                    name: "{$plugin.name}",
                },
                dataType: "json",
        ...
        EBCMS.download = function() {
            ...
            $.ajax({
                type: "GET",
                url: "{echo $router->build('/ebcms/plugin/download')}",
                dataType: "json",
                success: function(response) {
                    if (response.errcode) {
                        EBCMS.stop(response.message);
        ...
        EBCMS.backup = function() {
            ...
            $.ajax({
                type: "GET",
                url: "{echo $router->build('/ebcms/plugin/backup')}",
                dataType: "json",
                success: function(response) {
                    if (response.errcode) {
                        EBCMS.stop(response.message);
        ...
        EBCMS.cover = function() {
            ...
            $.ajax({
                type: "GET",
                url: "{echo $router->build('/ebcms/plugin/cover')}",
                dataType: "json",
                success: function(response) {
                    if (response.errcode) {
        ...
        EBCMS.rollback = function(msg) {
            ...
            $.ajax({
                type: "GET",
                url: "{echo $router->build('/ebcms/plugin/rollback')}",
                dataType: "json",
                success: function(response) {
                    if (response.errcode) {
